...
class Smart_Upsell_Public {
    ...
    // TUZATILDI: To'g'ri file path
    public function enqueue_styles() {
        wp_enqueue_style(
            $this->plugin_name,
            plugin_dir_url( dirname( __FILE__ ) ) . 'assets/css/smart-upsell-public.css',
            [],
            $this->version,
            'all'
        );
    ...
    public function enqueue_scripts() {
        wp_enqueue_script(
            $this->plugin_name,
            plugin_dir_url( dirname( __FILE__ ) ) . 'assets/js/smart-upsell-public.js',
            [ 'jquery' ],
            $this->version,
            true  // TUZATILDI: false dan true ga (footer-da yuklash)
        );
    ...
    // This is the unified handler now
